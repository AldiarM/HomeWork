...
sisters=("Many","Nika","Bella","Olli",)
print(sisters)
brothers=("Maxim","Rom","Tima","Alex")
print(brothers)
...
# #task 5
siblings=("Manny","Nima","Bella","Lia","Miko","Rom","Dony")
family_members=siblings + ( "Nolla", ) + ("Valli",)
print(family_members)

# Livel 2

# task 1
family_members=("Manny","Nima","Bella","Lia","Miko","Rom","Dony")
